...
lint:
	...
	poetry run pylint tygr/ --score=no --reports=no
	@echo "✅ Linting complete!"

type-check:
	@echo "🔍 Type checking with mypy..."
	poetry run mypy tygr/
	@echo "🔍 Type checking with pyright..."
	poetry run pyright tygr/
	@echo "✅ Type checking complete!"

security:
	@echo "🔒 Running security checks with bandit..."
	poetry run bandit -r tygr/ -c pyproject.toml
...
test-cov:
	...
	poetry run pytest -v --cov=tygr --cov-report=term-missing --cov-report=html
