...
from tygr.tools.registry import register_tool
...
def create_agent(
    ...
    try:
        ...
        if module_list:
            from tygr.prompts import get_all_module_names, validate_module_names
        ...
        from tygr.agents.state import AgentState
