...
from tygr.llm.config import LLMConfig
from tygr.telemetry.tracer import Tracer, set_global_tracer
...
class ChatTextArea(TextArea):  # type: ignore[misc]
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._app_reference: TygrTUIApp | None = None

    def set_app_reference(self, app: "TygrTUIApp") -> None:
...
class SplashScreen(Static):  # type: ignore[misc]
    ...
    def _build_welcome_text(self) -> Text:
        ...
        text.append("TYGR", style=Style(color=self.PRIMARY_GREEN, bold=True))
    ...
    def _build_start_line_text(self, phase: int) -> Text:
        ...
        tygr_style = Style(color=self.PRIMARY_GREEN, bold=bool(emphasize))

        text = Text("Starting ", style=base_style)
        text.append("TYGR", style=tygr_style)
...
class TygrTUIApp(App):  # type: ignore[misc]
    ...
    def _start_scan_thread(self) -> None:
        def scan_target() -> None:
            try:
                ...
                try:
                    agent = TygrAgent(self.agent_config)
    ...
    def _render_chat_content(self, msg_data: dict[str, Any]) -> str:
        ...
        if role == "user":
            from tygr.interface.tool_components.user_message_renderer import UserMessageRenderer
    ...
    def _render_tool_content_simple(self, tool_data: dict[str, Any]) -> str:
        ...
        from tygr.interface.tool_components.registry import get_tool_renderer
    ...
    def _send_user_message(self, message: str) -> None:
        ...
        try:
            from tygr.tools.agents_graph.agents_graph_actions import send_user_message_to_agent
    ...
    def action_confirm_stop_agent(self, agent_id: str) -> None:
        ...
        try:
            from tygr.tools.agents_graph.agents_graph_actions import stop_agent
...
async def run_tui(args: argparse.Namespace) -> None:
    """Run TYGR in interactive TUI mode with textual."""
    app = TygrTUIApp(args)
    await app.run_async()
