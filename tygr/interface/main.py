#!/usr/bin/env python3
"""
TYGR Security Platform - Agent Interface
"""
...
from tygr.interface.cli import run_cli
from tygr.interface.tui import run_tui
from tygr.interface.utils import (
...
from tygr.runtime.docker_runtime import TYGR_IMAGE
from tygr.telemetry.tracer import get_global_tracer
...
def validate_environment() -> None:  # noqa: PLR0912, PLR0915
    ...
    if not os.getenv("TYGR_LLM"):
        missing_required_vars.append("TYGR_LLM")
    ...
    if missing_required_vars:
        ...
        for var in missing_required_vars:
            if var == "TYGR_LLM":
                ...
                error_text.append("TYGR_LLM", style="bold cyan")
                error_text.append(
        ...
        error_text.append("\nExample setup:\n", style="white")
        error_text.append("export TYGR_LLM='openai/gpt-5'\n", style="dim white")
        ...
        panel = Panel(
            error_text,
            title="[bold red]🛡️  TYGR CONFIGURATION ERROR",
            title_align="center",
            border_style="red",
            padding=(1, 2),
        )
...
def check_docker_installed() -> None:
    if shutil.which("docker") is None:
        ...
        panel = Panel(
            error_text,
            title="[bold red]🛡️  TYGR STARTUP ERROR",
            title_align="center",
            border_style="red",
            padding=(1, 2),
        )
...
async def warm_up_llm() -> None:
    ...
    try:
        model_name = os.getenv("TYGR_LLM", "openai/gpt-5")
...
Examples:
  ...
  tygr --target https://example.com

  # GitHub repository analysis
  tygr --target https://github.com/user/repo
  tygr --target git@github.com:user/repo.git

  # Local code analysis
  tygr --target ./my-project

  # Domain penetration test
  tygr --target example.com

  # Multiple targets (e.g., white-box testing with source and deployed app)
  tygr --target https://github.com/user/repo --target https://example.com
  tygr --target ./my-project --target https://staging.example.com --target https://prod.example.com

  # Custom instructions
  tygr --target example.com --instruction "Focus on authentication vulnerabilities"
        """,
    )
...
def display_completion_message(args: argparse.Namespace, results_path: Path) -> None:
    ...
    panel = Panel(
        panel_content,
        title="[bold green]🛡️  TYGR SECURITY PLATFORM",
        title_align="center",
...
def pull_docker_image() -> None:
    ...
    if image_exists(client, TYGR_IMAGE):
        return

    console.print()
    console.print(f"[bold cyan]🐳 Pulling Docker image:[/] {TYGR_IMAGE}")
    ...
    with console.status("[bold cyan]Downloading image layers...", spinner="dots") as status:
        try:
            ...
            for line in client.api.pull(TYGR_IMAGE, stream=True, decode=True):
            ...
            error_text.append("\n\n", style="white")
            error_text.append(f"Could not download: {TYGR_IMAGE}\n", style="white")
